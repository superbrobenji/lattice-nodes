...
extern bool pb_default_field_callback(pb_istream_t* istream, pb_ostream_t* ostream,
...
#define PB_GEN_FIELD_INFO_AUTO(structname, atype, htype, ltype, fieldname, tag)                    \
  PB_FIELDINFO_AUTO2(                                                                              \
      PB_FIELDINFO_WIDTH_AUTO(_PB_ATYPE_##atype, _PB_HTYPE_##htype, _PB_LTYPE_##ltype), tag,       \
...
#define PB_FIELDINFO_ASSERT_AUTO2(width, tag, type, data_offset, data_size, size_offset,           \
                                  array_size)                                                      \
  PB_FIELDINFO_ASSERT_AUTO3(width, tag, type, data_offset, data_size, size_offset, array_size)

#define PB_FIELDINFO_ASSERT_AUTO3(width, tag, type, data_offset, data_size, size_offset,           \
                                  array_size)                                                      \
